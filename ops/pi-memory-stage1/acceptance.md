...
- **Adapted:** two migration transactions instead of an unsafe combined
  expansion/validation transaction; migrations regenerated after canonical #34234, #34272, #34273, #34304 and #34317 merged.
