...
- **Adapted:** two migration transactions instead of an unsafe combined
  expansion/validation transaction; migrations renumbered after #34234 merged.
