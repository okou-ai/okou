...
| 5   | Final repair diff stays in `ops/pi-memory-stage1`. Canonical main supplies the renamed-checkout and workflow-test isolation fixes; see `v1/validation.md`. | Original D's other nine areas and all accepted fences retain their implementation.                                        |
