...
| 5   | Repair files remain entirely in `ops/pi-memory-stage1`; all runtime/DB/ledger files are unchanged.                                           | Original D's other nine areas and all accepted fences retain their implementation.                                        |
