...
1. `1136_pi_memory_stage1_billing_context` replaces only the two context checks
...
2. Commit releases the `ACCESS EXCLUSIVE` locks before
   `1137_validate_pi_memory_stage1_billing_context` scans the existing rows in a
...
validators are retained unchanged. D metadata was regenerated as 1136/1137
against canonical main `a797f9d8596a28bd23dc2b66a4b8e8359326b02a`.
