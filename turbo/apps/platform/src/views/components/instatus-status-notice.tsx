    ...
    <div
      ...
      className={
        placement === "sidebar"
          ...
          : "pointer-events-none fixed inset-x-3 bottom-safe-offset-4 z-40 flex max-h-[calc(100dvh-32px)] flex-col gap-3 overflow-y-auto sm:left-6 sm:right-auto sm:w-[390px]"
      }
    >
      {issues.map((issue) => {
        return (
