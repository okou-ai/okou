...
export function OnboardingStepLayout({
  ...
  return (
    <div className="relative box-border flex h-full max-h-full min-h-full w-full overflow-hidden bg-sidebar pb-(--sab) text-foreground">
      ...
      >
        {/* The question stays on the rail's own surface, anchored to the top so
            the track starts on the sheet's own first line and neither it nor
            the title moves as a step's words run longer. */}
        <div className="w-full shrink-0 px-6 pt-8 pb-6 lg:w-[380px] lg:px-10 lg:py-10">
