...
test("Members manage Paid tools inside Chat independently of Chat preferences", async () => {
...
test("Disabled rollout hides Chat and resolves direct links to Preferences", async () => {
  await setupPage({
    context,
    path: "/?settings=chat",
