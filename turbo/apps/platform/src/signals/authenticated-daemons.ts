...
import { subscribeComposerConnectorOverview$ } from "./okou-page/composer-connector-overview.ts";
import { subscribeComposerAgentConnectors$ } from "./okou-page/composer-agent-connectors.ts";
...
const runAppRealtimeDaemons$ = command(
  async (
    ...
    set(subscribeComposerConnectorOverview$, signal);
    set(subscribeComposerAgentConnectors$, signal);
