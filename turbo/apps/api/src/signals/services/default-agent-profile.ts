...
import { DEFAULT_AGENT_DISPLAY_NAME as CORE_DEFAULT_AGENT_DISPLAY_NAME } from "@okouai/core/brand-presentation";

export const DEFAULT_AGENT_NAME = "default-agent";
export const DEFAULT_AGENT_DISPLAY_NAME = CORE_DEFAULT_AGENT_DISPLAY_NAME;
