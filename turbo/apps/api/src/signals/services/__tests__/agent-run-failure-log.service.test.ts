...
describe("canonical agent run failure logging", () => {
  it("retains bounded platform route evidence for built-in overload", () => {
    logAgentRunFailure({
  ...
  it("keeps incomplete ownership conservative and omits a non-built-in runtime route", () => {
    logAgentRunFailure({
  ...
  it("projects only the bounded API-first diagnostic on an unresolved route", () => {
