  ...
  return [
    ...
    ...(args.cloudBrowserEnabled === true
      ? [
          ...
          "- Browser form input: use `okou browser input-request` only when the user must personally enter the form content; fill ordinary forms with `agent-browser` instead.",
        ]
      : []),
