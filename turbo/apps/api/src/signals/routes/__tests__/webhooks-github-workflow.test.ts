...
function githubPullRequestPayload(args: {
  ...
  return JSON.stringify({
    ...
    pull_request: {
      ...
      html_url: `https://github.com/okou-ai/okou/pull/${number}`,
      draft: false,
      merged,
...
function githubPullRequestReviewPayload(args: {
  ...
  return JSON.stringify({
    ...
    review: {
      ...
      state: args.state,
      html_url: "https://github.com/okou-ai/okou/pull/42#pullrequestreview-903",
      commit_id: "abc123",
    ...
    pull_request: {
      ...
      html_url: "https://github.com/okou-ai/okou/pull/42",
      draft: false,
      base: { ref: "main" },
...
function githubWorkflowRunPayload(args: {
  ...
  return JSON.stringify({
    ...
    workflow_run: {
      ...
      head_sha: "abc123",
      event: "push",
      html_url: "https://github.com/okou-ai/okou/actions/runs/555",
    ...
    payload: (installationId) => {
      return JSON.stringify({
        ...
        workflow_job: {
          ...
          head_branch: "main",
          head_sha: "abc123",
          run_url: "https://api.github.com/repos/okou-ai/okou/actions/runs/902",
          run_attempt: 1,
          name: "test",
          status: "completed",
          conclusion: "failure",
          html_url: "https://github.com/okou-ai/okou/actions/runs/902/job/901",
    ...
    payload: (installationId) => {
      return JSON.stringify({
        ...
        comment: {
          ...
          html_url: "https://github.com/okou-ai/okou/pull/42#issuecomment-907",
          user: { id: 202, login: "trusted-user", type: "User" },
          author_association: "MEMBER",
        },
        repository: { id: 456, full_name: "okou-ai/okou" },
