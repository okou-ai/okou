  ...
  ({ className, children, variant = "default", ...props }, ref) => {
    return (
      <SelectPrimitive.Trigger
        ...
        className={cn(
          "flex h-9 w-full items-center justify-start gap-2 rounded-lg border border-[hsl(var(--gray-400))] bg-input px-3 py-2 text-sm text-foreground outline-hidden focus-visible:ring-2 focus-visible:ring-ring disabled:cursor-not-allowed disabled:opacity-50",
          variant === "neutral" &&
