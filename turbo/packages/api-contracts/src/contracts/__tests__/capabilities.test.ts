...
describe("CAPABILITIES", () => {
  it("should have exactly 52 capabilities", () => {
    expect(CAPABILITIES).toHaveLength(52);
  });
  ...
  it("should include Slack read and write capabilities", () => {
    expect(CAPABILITIES).toContain("slack:read");
  ...
  it("should include current Run usage read capability", () => {
    expect(CAPABILITIES).toContain("run-usage:read");
  });
