...
const morningBriefUnavailableReasonSchema = z.enum([
  "missing-timezone",
  "missing-default-agent",
]);

const morningBriefPreferenceResponseSchema = z.object({
...
const morningBriefPreferenceUpdateSchema = z.object({
  enabled: z.boolean(),
});

const morningBriefPreferenceErrorCodeSchema = z.enum([
...
const morningBriefPreferenceErrorSchema = z.object({
  error: z.object({
