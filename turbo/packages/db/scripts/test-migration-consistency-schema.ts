...
import { validatePermanentUsageDedupProvenance } from "./test-usage-dedup-provenance-permanent";
...
async function main(): Promise<void> {
  ...
  try {
    ...
    await validatePermanentUsageDedupProvenance(dbUrl1);
    ...
    await validatePermanentUsageDedupProvenance(dbUrl2);
