...
Migration 1167 creates empty additive stable-context tables after retained main
migrations through `1166_feishu_platform_agent_preferences`. It intentionally
...
Run from `turbo/packages/db` only after migration 1167 is present:
