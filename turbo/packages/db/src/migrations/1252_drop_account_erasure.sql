-- Retire account erasure after active-run migrations 1249/1250 and
-- Computer Use migration 1251. Old APIs touching these tables during
-- deployment fail; rollback below this API revision is unsupported.
