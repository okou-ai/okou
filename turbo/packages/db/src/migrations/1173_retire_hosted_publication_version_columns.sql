...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM drizzle.__drizzle_migrations WHERE created_at >= 1789871783548
  ) THEN
    RAISE EXCEPTION 'Hosted publication column retirement requires phase-A migration 1172';
  END IF;
