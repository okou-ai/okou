...
ALTER TABLE "morning_brief_generations" ADD CONSTRAINT "chk_morning_brief_generation_language_source" CHECK ("morning_brief_generations"."language_source" IN ('agent-instructions', 'member-locale', 'default'));