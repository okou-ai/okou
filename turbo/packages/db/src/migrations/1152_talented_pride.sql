...
CREATE TABLE "pi_stable_context_generations" (
	...
	CONSTRAINT "pi_stable_context_generations_token_check" CHECK (("pi_stable_context_generations"."publication_state" = 'pending' AND "pi_stable_context_generations"."publication_token" IS NOT NULL) OR ("pi_stable_context_generations"."publication_state" = 'ready' AND "pi_stable_context_generations"."publication_token" IS NULL)),
...
CREATE INDEX "pi_stable_context_heads_lease_idx" ON "pi_stable_context_heads" USING btree ("lease_expires_at","id") WHERE "pi_stable_context_heads"."status" = 'running';