...
export function presentationTemplateSkillInstruction(): string {
  ...
  return [
    ...
    `When the user designates an exact 40-hex commit under \`https://github.com/okou-ai/Template-artifact/tree/<commit>/${PRESENTATION_REVERSE_TEMPLATE_RESOURCE_PATH}\` as authoritative, read that pinned official guide and its referenced assets directly; do not pull or compare the registry copy.`,
