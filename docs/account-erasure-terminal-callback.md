...
Scope: [#34415](https://github.com/vm0-ai/vm0/issues/34415), under
[#33745](https://github.com/vm0-ai/vm0/issues/33745). This extends the accepted
...
| Failure     | Transaction rolls back; no conversion to closed or duplicate                                               | Existing preparation-failure drain/cleanup/rethrow path                                     |
...
uses the per-run event index. Existing provenance/history preparation remains
