...
| A: identity, schema, gate, status, fixtures | [Actual provider PR #36665](https://github.com/okou-ai/okou/pull/36665), validated at `b29652434c60b2c2351729e9ac70b1c8ddceb753`; settings fields, mutations, UUID selection and feature default match F. [Protected fixture publication](https://github.com/okou-ai/okou/issues/36640#issuecomment-5811911158).                           | The [accepted user-channel invalidation repair](https://github.com/okou-ai/okou/issues/36640#issuecomment-5812177311) needs published-source verification. Protected merge, review/CI, lifecycle/erasure and live fixture acceptance remain required.                                                                                                  |
...
| F: settings/source presentation/guide       | [Exact temporary A+F validation receipt](https://github.com/okou-ai/okou/issues/36645#issuecomment-5812258650): all 13 settings UI tests and all three scoped lint stages pass. All 3 source UI tests execute and fail at missing C schema validation; production types have 5 C-source errors.                                            | Actual C source integration, final production types/both UI suites, current-HEAD independent review, required CI, protected merge and authorized browser evidence remain required. Temporary provider validation is not merged-main or live-guild acceptance.                                                                                          |
