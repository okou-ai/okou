...
| D: Gateway relay                            | [PR #36660](https://github.com/okou-ai/okou/pull/36660) open.                                                                                                                                                                                                                                                              | Merge, deployment/config tooling, replay/reconnect evidence, and authorized live relay acceptance remain required.                       |
