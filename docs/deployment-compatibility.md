...
responses from an older API remain valid.

Only the new archive routes append the new event kinds, and the Web archive
controls stay behind the `ChatThreadArchiving` switch. Web bundles, CLI builds
