...
Migration 1167, following retained main migrations through
`1166_feishu_platform_agent_preferences`, adds
...
other product data. Keep stable-context activation on hold until migration 1167
