...
- Migration `1244_drop_discord_chat_deliveries` drops `discord_chat_deliveries`
...
- Migration `1245_chat_event_retention_cursors` adds the retention sweep
...
`1244_drop_discord_chat_deliveries` drops the table (see above).
