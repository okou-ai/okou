...
| runner-supervisor        | Start-loop idle replenishment, pre-claim preference/admission/claim rollback, claimed-idle reservation/rollback, finalizing-successor arbitration, claimed resource selection/activation and status/failure recovery, post-executor sandbox finalization, heartbeat, claimed-run completion settlement, ownership transitions, and orphan recovery above domain owners |
