...
| runner-supervisor        | Start-loop idle replenishment, claimed-idle reservation/rollback, finalizing-successor wait and fallback arbitration, post-executor sandbox finalization, heartbeat, claimed-run completion settlement, ownership transitions, and orphan recovery above domain owners |
