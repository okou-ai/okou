...
| runner-supervisor        | Start-loop idle replenishment, pre-claim preference/admission/claim rollback and pending finalizing-candidate state, claimed-idle reservation/rollback, finalizing-successor arbitration, claimed resource selection/activation and status/failure recovery, post-executor finalizing and sandbox finalization, provider report ordering, active-run completion settlement, panic disposition recovery, heartbeat, ownership transitions, and orphan recovery above domain owners |
