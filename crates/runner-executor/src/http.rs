...
pub fn normalize_api_base_url(value: &str) -> RunnerResult<String> {
...
impl ApiRequestBuilder {
    ...
    pub fn prepare(self, endpoint_label: &'static str) -> RunnerResult<PreparedApiRequest> {
...
impl ClientHeaders {
    fn new(client_session_id: String, runner_version: &'static str) -> RunnerResult<Self> {
