...
pub enum RestoredSessionIdentityMismatchReason {
    Framework,
    SessionIdentity,
    HistoryRefKind,
...
impl RestoredSessionIdentityMismatchReason {
    ...
    pub const fn history_hash_size_relationship_action_type(self) -> Option<&'static str> {
        match self {
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub enum RestoredSessionHistoryHashSizeRelationship {
    RequestedSmaller,
    RequestedEqual,
    RequestedLarger,
    SizeUnknown,
...
#[derive(Clone, Eq)]
pub struct RestoredSessionIdentity {
...
pub struct RestoredSessionFinalMetadataVerification<'a> {
...
#[derive(Clone)]
pub struct RestoredSessionHistoryPrefixAttribution {
    history_hash: String,
...
impl RestoredSessionIdentity {
    ...
    pub fn claude_code_for_test(history_hash: impl Into<String>) -> Self {
        Self::new(
    ...
    #[cfg(any(test, feature = "test-support"))]
    pub fn history_size_bytes(&self) -> Option<u64> {
        self.history_size_bytes
    }

    #[cfg(any(test, feature = "test-support"))]
    pub fn final_metadata_path(&self) -> Option<&str> {
        match &self.verifier {
    ...
    pub fn final_metadata_verification(
        &self,
    ...
    pub fn has_final_metadata_verification(&self) -> bool {
    ...
    pub fn mismatch_reason_and_prefix_attribution(
        &self,
        requested: &Self,
    ) -> (
    ...
    pub fn is_verified_match_for_request(&self, requested: &Self) -> bool {
        self == requested
    ...
    pub fn mismatch_reason_for_request(
        &self,
        requested: &Self,
    ) -> Option<RestoredSessionIdentityMismatchReason> {
...
impl RestoredSessionHistoryPrefixAttribution {
    #[cfg(any(test, feature = "test-support"))]
    pub fn for_test(history_hash: String, history_size_bytes: u64) -> Self {
        Self {
            history_hash,
            history_size_bytes,
        }
...
pub const FINAL_SESSION_HISTORY_IDENTITY_READ_LIMIT: u64 =
