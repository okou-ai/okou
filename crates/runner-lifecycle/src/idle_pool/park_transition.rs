...
pub struct IdleParkRequestParts {
    pub run_id: RunId,
...
impl IdleParkCandidate {
    pub fn into_finalizing_handoff(
        self,
    ...
    pub fn with_last_completed_at(self, last_completed_at: String) -> Self {
        match self {
            Self::Ordinary(candidate) => {
...
pub struct IdleParkNonReusable {
    pub reason: SandboxParkNonReusableReason,
    pub preparation_report: ReusePreparationReport,
}
...
pub struct IdleParkActiveParts {
    pub sandbox: Box<dyn Sandbox>,
    pub factory: Arc<Box<dyn SandboxFactory>>,
    pub budget_lease: BudgetLease,
    pub workspace_promotion: Option<WorkspaceImagePromotionContext>,
...
pub enum SpeculativeReparkResult {
...
impl IdleParkRequest {
    ...
    pub fn new(parts: IdleParkRequestParts) -> Self {
        Self { parts }
    }

    #[cfg(any(test, feature = "test-support"))]
    pub async fn park_for_idle(self) -> Result<IdleParkOutcome, IdleParkFailure> {
    ...
    pub async fn park_for_idle_with_observer(
        self,
...
impl IdleParkOutcome {
    ...
    pub fn into_parts(self) -> (IdleParkCandidate, Option<IdleParkNonReusable>) {
        match self {
    ...
    #[cfg(any(test, feature = "test-support"))]
    pub fn expect_reusable(self) -> ParkedIdleCandidate {
        match self {
...
impl IdleParkFailure {
    ...
    pub fn into_parts(self) -> IdleParkFailureParts {
        let Self {
            ownership,
            reason,
            error,
