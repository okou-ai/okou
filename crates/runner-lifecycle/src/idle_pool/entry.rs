...
impl IdleSandboxIdentity {
    pub fn kind(&self) -> IdleSandboxKind {
        match self {
...
pub struct ImmediateHandoffCandidate {
    pub(super) resources: IdleSandboxResources,
    pub(super) metadata: IdleSandboxMetadata,
    pub(super) budget_lease: BudgetLease,
...
pub struct FinalizingHandoffCandidate {
...
impl ParkedIdleCandidate {
    ...
    pub fn with_last_completed_at(mut self, last_completed_at: String) -> Self {
...
impl ImmediateHandoffCandidate {
    pub fn handoff_point(&self) -> SandboxFinalExecParkHandoffPoint {
        self.handoff_point
    }
...
impl FinalizingHandoffCandidate {
    ...
    pub fn into_destroy_job(self: Box<Self>) -> IdleDestroyJob {
    ...
    pub fn into_candidate(self: Box<Self>) -> IdleParkCandidate {
        self.candidate
    }
}
...
pub struct SpeculativeIdleSandbox {
    pub(super) entry: IdleEntry,
}

pub enum SpeculativeIdleUnparkResult {
...
impl IdleDestroyJob {
    ...
    pub fn into_retiring_parts(self) -> (IdleDestroyPayload, BudgetLease) {
        let Self {
            payload,
            budget_lease,
            reuse_key: _,
...
impl ReservedIdleSandbox {
    ...
    pub async fn try_unpark_for_speculation(self, run_id: RunId) -> SpeculativeIdleUnparkResult {
