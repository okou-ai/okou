...
readonly PUBLIC_BRAND_RETIREMENT_PATH=turbo/packages/db/src/migrations/1242_retire_public_brand.sql
...
# Migration 1242 drops the remaining non-link public_brand columns (including
