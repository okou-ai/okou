...
readonly PUBLIC_BRAND_RETIREMENT_PATH=turbo/packages/db/src/migrations/1245_retire_public_brand.sql
...
# Migration 1245 drops the remaining non-link public_brand columns (including
