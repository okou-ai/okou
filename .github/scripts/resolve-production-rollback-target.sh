...
readonly PUBLIC_BRAND_RETIREMENT_PATH=turbo/packages/db/src/migrations/1246_retire_public_brand.sql
...
# Migration 1246 drops the remaining non-link public_brand columns (including
