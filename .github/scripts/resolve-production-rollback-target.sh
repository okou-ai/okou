...
readonly PUBLIC_BRAND_RETIREMENT_PATH=turbo/packages/db/src/migrations/1244_retire_public_brand.sql
...
# Migration 1244 drops the remaining non-link public_brand columns (including
