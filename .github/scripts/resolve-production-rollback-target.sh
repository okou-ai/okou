...
readonly PUBLIC_BRAND_RETIREMENT_PATH=turbo/packages/db/src/migrations/1251_retire_public_brand.sql
...
# Migration 1251 drops the remaining non-link public_brand columns (including
